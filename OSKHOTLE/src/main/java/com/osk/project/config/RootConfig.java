package com.osk.project.config;
...
@Configuration
@ComponentScan(basePackages = {"com.osk.project.service"})
@ComponentScan(basePackages = {"com.osk.project.aspect"})
@EnableAspectJAutoProxy
@MapperScan(basePackages = {"com.osk.project.persistence"})
...
public class RootConfig {
   ...
   public DataSource dataSource() { // DataSource 객체 리턴 메서드
      ...
      config.setJdbcUrl("jdbc:oracle:thin:@192.168.75.185:1521:xe"); // DB 연결 url

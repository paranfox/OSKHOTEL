...
public interface ReservationInfoMapper {
	...
	List<ReservationInfoVO> selectListByDate(@Param("reservationCheckIn") String reservationCheckIn, @Param("reservationCheckOut") String reservationCheckOut); // 일정 기간 내의 예약 정보
